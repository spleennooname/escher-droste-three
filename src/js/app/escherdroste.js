define([
  ...
  var ready = function () {
    ...
    onload = function () {
      ...
      texture_shader.minFilter = THREE.LinearFilter;
      ...
      t1 = new TWEEN.Tween({
          x: -10, y: -10, z: 200, rx: 0, ry: 0, rz: 0
        })
        .to({
          x: -18.0, y: -8.0, z: 11.0, rz: -Math.PI / 2, rx: -Math.PI / 6, ry: -Math.PI / 6
        }, 2500)
